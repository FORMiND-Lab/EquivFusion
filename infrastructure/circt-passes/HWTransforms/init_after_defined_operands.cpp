...
namespace hw {
#define GEN_PASS_DEF_EQUIVFUSIONINITAFTERDEFINEDOPERANDS
...
namespace {
struct EquivFusionInitAfterDefinedOperandsPass
        : public circt::equivfusion::hw::impl::EquivFusionInitAfterDefinedOperandsBase<EquivFusionInitAfterDefinedOperandsPass> {
    void runOnOperation() override;
};
} // namespace

void EquivFusionInitAfterDefinedOperandsPass::runOnOperation() {
